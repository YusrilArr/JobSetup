<!-- Baris 1-31 Admin LTE Dashboard -->
<!DOCTYPE html>
<html>
    ...
    <head>
        ...
        <!-- Penambahan CSS JQuery UI -->
        <link rel="stylesheet" type="text/css"
            href="<?php echo base_url(); ?>assets/admin/plugins/jquery-ui/jquery-ui.min.css">
        <!-- Panggil viewer js -->
